...
<template>
  <main class="stats-page" :class="{ 'stats-page--embedded': props.embedded }" data-mood="palais">
    ...
    <div class="stats-page__content">
      ...
      <p v-if="playerStore.isLoading && !selectedCharacter" class="stats-page__status">Chargement…</p>
      <p v-else-if="!selectedCharacter" class="stats-page__status">Aucun personnage disponible.</p>
      <CharacterStatsTab v-else :character="selectedCharacter" />
    </div>
  </main>
</template>
...
.stats-page__back:hover { color: var(--gold); }
