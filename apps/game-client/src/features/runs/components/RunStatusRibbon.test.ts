...
describe('RunStatusRibbon', () => {
  ...
  it('displays the room number chip', () => {
    const wrapper = mountRibbon(baseRun);
    expect(wrapper.text()).toContain('Salle 1');
  });

  it('displays the room type chip', () => {
    const wrapper = mountRibbon(baseRun);
  ...
  it('shows plural for multiple laws', () => {
    const run = {
      ...baseRun,
      activePalaceLaws: [
  ...
  it('shows curses button when curses exist', () => {
  ...
  it('shows modifiers button when modifiers exist', () => {
  ...
  it('shows quit room button when not at safe point', () => {
    const wrapper = mountRibbon(baseRun, false);
    expect(wrapper.text()).toContain('Quitter la salle');
  });

  it('hides quit room button at safe point', () => {
    const wrapper = mountRibbon(baseRun, true);
