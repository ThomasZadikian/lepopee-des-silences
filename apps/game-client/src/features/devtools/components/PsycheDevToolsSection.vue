...
<template>
  <section class="devtools-card">
    <header class="devtools-card__header">
      <h3>Psyché du Palais</h3>
...
.devtools-psyche__bars li { display: grid; grid-template-columns: 96px 1fr 44px; align-items: center; gap: 8px; }
.devtools-psyche__label { font-size: 11px; color: var(--ink-4, #a49a88); }
.devtools-psyche__track { height: 10px; border-radius: 5px; background: oklch(0.11 0.025 270 / 0.9); overflow: hidden; }
.devtools-psyche__fill { display: block; height: 100%; background: var(--gold, #d7b56d); }
.devtools-psyche__value { font-size: 11px; text-align: right; }
.devtools-psyche__subtitle { font-size: 11px; letter-spacing: 0.12em; text-transform: uppercase; color: var(--ink-4, #a49a88); margin-top: 4px; }
.devtools-psyche__trajectory { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 5px; }
.devtools-psyche__trajectory li { display: grid; grid-template-columns: 36px 100px 1fr; align-items: center; gap: 8px; }
.devtools-psyche__depth { font-size: 11px; color: var(--ink-4, #a49a88); }
.devtools-psyche__step-dominant { font-size: 12px; }
.devtools-psyche__spark { display: flex; height: 8px; border-radius: 4px; overflow: hidden; background: oklch(0.11 0.025 270 / 0.9); }
