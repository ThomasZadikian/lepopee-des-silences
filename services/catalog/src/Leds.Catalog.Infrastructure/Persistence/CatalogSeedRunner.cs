...
public sealed partial class CatalogSeedRunner
{
    ...
    private async Task SeedCanonSkillsAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.priere-aspiration", "Prière",
            ...
            "Drain", "SingleEnemy", "Debuff", mana: 4, power: 12, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
        ...
        await UpsertSkillAsync("skill.temp.ecriture-appliquee", "Écriture appliquée",
            ...
            category: "Magic", cooldown: 1, emotionalRegister: "Memoire");
        ...
        await UpsertSkillAsync("skill.temp.construction-ephemere", "Construction éphémère",
            ...
            category: "Magic", cooldown: 2, emotionalRegister: "Deni");
        ...
        await UpsertSkillAsync("canon.skill.transmutation", "Transmutation",
            ...
            "Buff", "Self", "Buff", mana: 6, power: 0, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.brume", "Brume",
            ...
            "Debuff", "AllEnemies", "Debuff", mana: 7, power: 0, cancellationToken, emotionalRegister: "Silence", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.flamme-seraphine", "Flamme Séraphine",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 12, power: 34, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.se-taire", "Se taire",
            ...
            "Silence", "AllEnemies", "Status", mana: 0, power: 0, cancellationToken, emotionalRegister: "Silence", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.construction-perpetuelle", "Construction perpétuelle",
            ...
            "Buff", "Self", "Buff", mana: 14, power: 0, cancellationToken, emotionalRegister: "Memoire",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.liberte-retrouvee", "La liberté retrouvée",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 20, power: 14, cancellationToken, emotionalRegister: "Rupture",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.connaissance-academique", "Connaissance académique",
            ...
            "Buff", "AllAllies", "Buff", mana: 22, power: 0, cancellationToken, emotionalRegister: "Memoire",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.regard-infantile", "Regard infantile",
            ...
            "Debuff", "SingleEnemy", "Debuff", mana: 18, power: 0, cancellationToken, emotionalRegister: "Deni",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.clairvoyance", "Clairvoyance",
            ...
            "Debuff", "AllEnemies", "Debuff", mana: 16, power: 0, cancellationToken, emotionalRegister: "Memoire",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.impulsivite", "Impulsivité",
            ...
            "Buff", "Self", "Buff", mana: 12, power: 0, cancellationToken, emotionalRegister: "Rupture", allowedArchetypes: new[] { "GlassCannon" },
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.favorite-de-elise", "Favorite de Elise",
            ...
            "Buff", "Self", "Heal", mana: 24, power: 15, cancellationToken, emotionalRegister: "Melancolie",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.creation", "Création",
            ...
            "Buff", "SingleEnemy", "CopySkills", mana: 20, power: 10, cancellationToken, emotionalRegister: "Memoire",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.ecriture-continuelle", "Écriture continuelle",
            ...
            "Debuff", "SingleEnemy", "ExtendDotDuration", mana: 16, power: 25, cancellationToken, emotionalRegister: "Memoire", audience: "Any",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.larme-des-enfers", "Larme des enfers",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 14, power: 10, cancellationToken, emotionalRegister: "Melancolie",
        ...
        await UpsertSkillAsync("canon.skill.souffle-de-la-forge", "Souffle de la forge",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 16, power: 10, cancellationToken, emotionalRegister: "Rupture", audience: "Any",
        ...
        await UpsertSkillAsync("canon.skill.contemplation-infinie", "Contemplation infinie",
            ...
            "Debuff", "SingleEnemy", "Debuff", mana: 18, power: 0, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.silence", "Silence",
            ...
            "Debuff", "SingleEnemy", "Debuff", mana: 14, power: 0, cancellationToken, emotionalRegister: "Silence", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.larme-elise", "Larme d'Elise",
            ...
            "Buff", "Self", "Heal", mana: 18, power: 5, cancellationToken, emotionalRegister: "Melancolie",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.caresse-de-mane", "Caresse de Mané",
            ...
            "Buff", "Self", "Heal", mana: 16, power: 15, cancellationToken, emotionalRegister: "Melancolie",
            category: "Magic",
            basePowerIsPercentOfMaxVitality: true);
        ...
        await UpsertSkillAsync("canon.skill.plongee-dans-la-folie", "Plongée dans la folie",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 24, power: 20, cancellationToken, emotionalRegister: "Folie", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.egide", "Égide",
            ...
            "Buff", "Self", "Guard", mana: 10, power: 15, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            category: "Magic");

        await UpsertSkillAsync("canon.skill.rempart", "Rempart",
            "Élève de puissants remparts pour contrecarrer les attaques ennemies.",
            "Buff", "AllAllies", "Guard", mana: 16, power: 7, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.symphonie-des-enfers", "Symphonie des enfers",
            ...
            "Damage", "AllEnemies", "Damage", mana: 26, power: 6, cancellationToken, emotionalRegister: "Folie", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.deluge-du-styx", "Déluge du Styx",
            ...
            "Debuff", "AllEnemies", "Debuff", mana: 22, power: 0, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.destinee-cruelle", "Une destinée cruelle",
            ...
            "Buff", "Self", "Buff", mana: 30, power: 0, cancellationToken, emotionalRegister: "Rupture",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.fondations-de-thomas", "Fondations",
            ...
            "Buff", "SingleAlly", "Guard", mana: 14, power: 15, cancellationToken, emotionalRegister: "Memoire", allowedArchetypes: new[] { "Tank" },
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.veillee-de-mina", "Veillée",
            ...
            "Buff", "SingleAlly", "Buff", mana: 18, power: 0, cancellationToken, emotionalRegister: "Silence", allowedArchetypes: new[] { "Support" },
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.baiser-delise", "Baiser d'Elise",
            ...
            "Heal", "SingleAlly", "Heal", mana: 16, power: 20, cancellationToken, emotionalRegister: "Melancolie", allowedArchetypes: new[] { "Hybrid" },
            category: "Magic",
            basePowerIsPercentOfMaxVitality: true);
        ...
        await UpsertSkillAsync("canon.skill.vol-a-la-tire", "Vol à la tire",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 10, power: 16, cancellationToken, emotionalRegister: "Rupture", allowedArchetypes: new[] { "Opportunist" },
            effects: new[]
            {
    ...
    // Plateau est en vie, les debuffs infligés par un Veilleur durent 1 tour de plus)
    // est câblée directement dans CombatSkillEffectResolver.ApplyStatusEffectSpec,
    // calculée en direct sur la présence en vie du Porteur plutôt que via un hook
    // "mort d'un allié" dédié. Sur les 5 réactions "Attitude en combat" par créature :
    // "face à un coup très puissant" (≥25% MaxVitality en un coup) EST câblée pour les
    // 4 créatures (voir VeilleursDuSeuilBehaviors.cs — Chantier Bestiaire Phase 11/12),
    // chacune réagissant avec l'un de ses 4 sorts existants (invariant SFD §I) plutôt
    // qu'un effet dédié quand celui-ci n'est pas encore authorable (garde gratuite hors
    // action, soin boosté ponctuel, esquive garantie — voir les commentaires de classe
    // pour le détail des approximations). Les 4 autres lignes d'Attitude en combat par
    // créature (ennemi plus fort/faible, allié nommé présent, dernier survivant, joueur
    // silencieux) restent non câblées — prochaines passes du même chantier.
    private async Task SeedBestiaireVeilleursDuSeuilAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.pli-du-tapis", "Pli du tapis",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 9, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.etouffement-feutre", "Étouffement feutré",
            ...
            "Debuff", "SingleEnemy", "Debuff", mana: 8, power: 0, cancellationToken, emotionalRegister: "Silence", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.seuil-souille", "Seuil souillé",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 12, power: 14, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.service-du-the", "Service du thé",
            ...
            "Heal", "SingleAlly", "Heal", mana: 10, power: 12, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.tasse-retournee", "Tasse retournée",
            ...
            "Debuff", "SingleEnemy", "Debuff", mana: 12, power: 0, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.etiquette", "Étiquette",
            ...
            "Buff", "AllAllies", "Buff", mana: 8, power: 0, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.formule-creuse", "Formule creuse",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 9, power: 13, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.courbette-inversee", "Courbette inversée",
            ...
            "Buff", "Self", "Buff", mana: 11, power: 0, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.chute-de-marbre", "Chute de marbre",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 6, power: 18, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.verdict-du-seuil", "Verdict du seuil",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 16, power: 28, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            category: "Magic");
    ...
    private async Task SeedBestiaireCopistesAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.dictee", "Dictée",
            ...
            "Debuff", "SingleEnemy", "Debuff", mana: 10, power: 0, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.plume-seche", "Plume sèche",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 8, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.recharge", "Recharge",
            ...
            "Buff", "SingleAlly", "RestoreMana", mana: 0, power: 8, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.eclaboussure", "Éclaboussure",
            ...
            "Damage", "AllEnemies", "Damage", mana: 12, power: 10, cancellationToken, emotionalRegister: "Effroi", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.corps-de-verre", "Corps de verre",
            ...
            "Buff", "Self", "Guard", mana: 8, power: 10, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.phrase-inachevee", "Phrase inachevée",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 10, power: 12, cancellationToken, emotionalRegister: "Silence", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.marge-blanche", "Marge blanche",
            ...
            "Debuff", "SingleEnemy", "Debuff", mana: 8, power: 0, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.repli-de-papier", "Repli de papier",
            ...
            "Buff", "Self", "Guard", mana: 0, power: 8, cancellationToken, emotionalRegister: "Silence", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.couture", "Couture",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 8, power: 16, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.reliure-de-chair", "Reliure de chair",
            ...
            "Debuff", "SingleEnemy", "Debuff", mana: 14, power: 0, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.noeud-final", "Nœud final",
            "Le livre se ferme.",
            "Damage", "SingleEnemy", "Damage", mana: 20, power: 24, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Magic");
    ...
    private async Task SeedBestiaireSqueletteDeSouvenirsAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.griffe-dos", "Griffe d'os",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 10, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Physical");

        await UpsertSkillAsync("canon.skill.fragment-grave", "Fragment gravé",
            "Lance un éclat d'os gravé : la cible voit le souvenir.",
            "Damage", "SingleEnemy", "Damage", mana: 6, power: 8, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            effects: new[] { new SkillEffectSpec("StatModifier", null, -2, TicksPerTurn * 2, Stat: "Focus") },
            category: "Magic");

        await UpsertSkillAsync("canon.skill.etreinte-creuse", "Étreinte creuse",
            "Agrippe : il cherche quelqu'un pour se souvenir de lui.",
            "Damage", "SingleEnemy", "Damage", mana: 4, power: 6, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.effondrement", "Effondrement",
            ...
            "Damage", "AllEnemies", "Damage", mana: 0, power: 6, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.braise-memorielle", "Braise mémorielle",
            ...
            "Buff", "Self", "Guard", mana: 8, power: 6, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Magic");

        await UpsertSkillAsync("canon.skill.jet-de-cendre", "Jet de cendre",
            "La cendre entre dans les yeux et la mémoire.",
            "Damage", "SingleEnemy", "Damage", mana: 7, power: 9, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            effects: new[] { new SkillEffectSpec("StatModifier", null, -3, TicksPerTurn * 3, Stat: "Focus") },
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.fardeau-partage", "Fardeau partagé",
            ...
            "Heal", "SingleAlly", "Heal", mana: 10, power: 8, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
            category: "Magic", basePowerIsPercentOfMaxVitality: true);
        ...
        await UpsertSkillAsync("canon.skill.berceuse-inversee", "Berceuse inversée",
            ...
            "Debuff", "AllEnemies", "Debuff", mana: 12, power: 0, cancellationToken, emotionalRegister: "Silence", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.note-tenue", "Note tenue",
            "L'accord final.",
            "Damage", "SingleEnemy", "Damage", mana: 18, power: 20, cancellationToken, emotionalRegister: "Silence", audience: "Enemy",
            category: "Magic");
    ...
    private async Task SeedBestiaireChimeresDesPlainesAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.morsure-composite", "Morsure composite",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 13, cancellationToken, emotionalRegister: "Folie", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.bond-de-flanc", "Bond de flanc",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 6, power: 10, cancellationToken, emotionalRegister: "Folie", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.curee", "Curée",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 8, power: 16, cancellationToken, emotionalRegister: "Folie", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.guet", "Guet",
            ...
            "Buff", "Self", "Guard", mana: 0, power: 6, cancellationToken, emotionalRegister: "Folie", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.designation", "Désignation",
            ...
            "Debuff", "SingleEnemy", "Debuff", mana: 6, power: 0, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.houlette", "Houlette",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 11, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.ration", "Ration",
            ...
            "Buff", "AllAllies", "Heal", mana: 10, power: 10, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            category: "Magic", basePowerIsPercentOfMaxVitality: true);

        await UpsertSkillAsync("canon.skill.brout", "Brout",
            "Passe son tour en broutant. Le calme s'épaissit.",
            "Buff", "Self", "Guard", mana: 0, power: 8, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.regard-fixe", "Regard fixe",
            ...
            "Debuff", "SingleEnemy", "Debuff", mana: 6, power: 0, cancellationToken, emotionalRegister: "Effroi", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.detente", "Détente",
            ...
            "Damage", "AllEnemies", "Damage", mana: 0, power: 26, cancellationToken, emotionalRegister: "Silence", audience: "Enemy",
            effects: new[] { new SkillEffectSpec("Silence", null, 0, TicksPerTurn) },
            category: "Magic");
    ...
    private async Task SeedBestiaireCreationsDuForgeronAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.coup-de-plaque", "Coup de plaque",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 12, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.foyer-ouvert", "Foyer ouvert",
            "Son torse s'ouvre.",
            "Debuff", "SingleEnemy", "Debuff", mana: 8, power: 0, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.frappe-denclume", "Frappe d'enclume",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 14, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Physical");

        await UpsertSkillAsync("canon.skill.cadence", "Cadence",
            "Le rythme s'accélère.",
            "Buff", "Self", "Buff", mana: 8, power: 0, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.coup-de-grace-forgeron", "Coup de grâce du forgeron",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 14, power: 22, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Physical");

        await UpsertSkillAsync("canon.skill.transmutation-alliee", "Transmutation",
            "Plomb, or, mercure, soufre, sel.",
            "Buff", "SingleAlly", "Buff", mana: 6, power: 0, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.litanie", "Litanie",
            ...
            "Buff", "AllAllies", "Buff", mana: 10, power: 0, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.scorie", "Scorie",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 8, power: 11, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.fonte", "Fonte",
            ...
            "Buff", "Self", "Buff", mana: 12, power: 0, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.contact", "Contact",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 8, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.laitier-ardent", "Laitier ardent",
            ...
            "Debuff", "SingleEnemy", "ExtendDotDuration", mana: 8, power: 40, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.eclat-vitrifie", "Éclat vitrifié",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 5, power: 9, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.reformation", "Reformation",
            "Se reforme.",
            "Buff", "Self", "Heal", mana: 6, power: 15, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Magic", basePowerIsPercentOfMaxVitality: true);
    ...
    private async Task SeedBestiaireBlousesBlanchesAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.placebo", "Placebo",
            ...
            "Buff", "Self", "Guard", mana: 10, power: 10, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.injection-blanche", "Injection blanche",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 8, power: 10, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.sonnette", "Sonnette",
            "Appelle.",
            "Buff", "Self", "Guard", mana: 8, power: 5, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.visite", "Visite",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 12, power: 14, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.tour-de-clef", "Tour de clef",
            ...
            "Debuff", "SingleEnemy", "Debuff", mana: 14, power: 0, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.trousseau", "Trousseau",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 13, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            category: "Physical");

        await UpsertSkillAsync("canon.skill.extinction-des-feux", "Extinction des feux",
            "Le règlement est appliqué.",
            "Damage", "SingleEnemy", "Damage", mana: 20, power: 24, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            category: "Magic");
    ...
    private async Task SeedBestiairePenitentsDeLaMontagneAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.baton-de-marche", "Bâton de marche",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 9, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
            category: "Physical");

        await UpsertSkillAsync("canon.skill.chapelet-de-dents", "Chapelet de dents",
            "Égrène.",
            "Damage", "SingleEnemy", "Damage", mana: 8, power: 11, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.repentir", "Repentir",
            ...
            "Buff", "Self", "Buff", mana: 6, power: 0, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.encens-inverse", "Encens inversé",
            ...
            "Debuff", "AllEnemies", "Debuff", mana: 10, power: 0, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.oraison-cousue", "Oraison cousue",
            "Le drain accompli.",
            "Damage", "SingleEnemy", "Damage", mana: 14, power: 18, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.derniere-priere", "Dernière prière",
            ...
            "Drain", "SingleEnemy", "Debuff", mana: 20, power: 18, cancellationToken, emotionalRegister: "Deni", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.posture-finale", "Posture finale",
            "Elle a vu.",
            "Debuff", "SingleEnemy", "Debuff", mana: 10, power: 0, cancellationToken, emotionalRegister: "Effroi", audience: "Enemy",
            effects: new[]
            {
        ...
        await UpsertSkillAsync("canon.skill.griffe-de-recul", "Griffe de recul",
            "Frappe en reculant.",
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 14, cancellationToken, emotionalRegister: "Effroi", audience: "Enemy",
            category: "Physical");
    ...
    private async Task SeedBestiaireFauxHabitantsDuJardinAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.salut-de-chapeau", "Salut de chapeau",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 10, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
            category: "Physical");

        await UpsertSkillAsync("canon.skill.conversation-tranquille", "Conversation tranquille",
            "Ça n'a ni début ni fin.",
            "Debuff", "SingleEnemy", "Debuff", mana: 8, power: 0, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
            effects: new[] { new SkillEffectSpec("StatModifier", null, -3, TicksPerTurn * 3, Stat: "Focus") },
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.pas-de-promenade", "Pas de promenade",
            ...
            "Buff", "Self", "Guard", mana: 4, power: 6, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
            category: "Physical");

        await UpsertSkillAsync("canon.skill.sifflotement", "Sifflotement",
            "Le souffle bouclé, projeté.",
            "Damage", "AllEnemies", "Damage", mana: 6, power: 8, cancellationToken, emotionalRegister: "Silence", audience: "Enemy",
            category: "Magic");

        await UpsertSkillAsync("canon.skill.secateur", "Sécateur",
            "Il taille les tiges et les tendons avec le même soin.",
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 13, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.emondage", "Émondage",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 10, power: 11, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.greffe", "Greffe",
            ...
            "Buff", "SingleAlly", "Buff", mana: 12, power: 0, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.paillage", "Paillage",
            ...
            "Buff", "SingleAlly", "Guard", mana: 8, power: 8, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
            category: "Magic");
    ...
    private async Task SeedBestiaireGardiensDeCrystalAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.poing-de-crystal", "Poing de crystal",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 0, power: 17, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Physical");

        await UpsertSkillAsync("canon.skill.refraction", "Réfraction",
            "Renvoie la lumière ancestrale.",
            "Damage", "SingleEnemy", "Damage", mana: 12, power: 15, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.facette", "Facette",
            ...
            "Buff", "Self", "Buff", mana: 8, power: 0, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.pulsation", "Pulsation",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 10, power: 12, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.prisme", "Prisme",
            ...
            "Buff", "Self", "Guard", mana: 14, power: 12, cancellationToken, emotionalRegister: "Memoire", audience: "Enemy",
            category: "Magic");
    ...
    private async Task SeedBestiaireEchosDEmotionsAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.explosion", "Explosion",
            "Ça devait éclater.",
            "Damage", "AllEnemies", "Damage", mana: 16, power: 20, cancellationToken, emotionalRegister: "Rupture", audience: "Enemy",
            category: "Magic");

        await UpsertSkillAsync("canon.skill.frisson", "Frisson",
            "Quelque chose a bougé derrière vous.",
            "Damage", "SingleEnemy", "Damage", mana: 6, power: 9, cancellationToken, emotionalRegister: "Effroi", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.saccade", "Saccade",
            ...
            "Buff", "Self", "Guard", mana: 4, power: 6, cancellationToken, emotionalRegister: "Effroi", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.constat-tardif", "Constat tardif",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 10, power: 16, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
            category: "Magic");
        ...
        await UpsertSkillAsync("canon.skill.silence-partage", "Silence partagé",
            ...
            "Damage", "AllEnemies", "Damage", mana: 12, power: 8, cancellationToken, emotionalRegister: "Silence", allowedArchetypes: new[] { "Hybrid" },
            category: "Magic");
    ...
    private async Task SeedBestiaireImperatriceDeLaFalaiseAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertSkillAsync("canon.skill.maree-montante", "Marée montante",
            ...
            "Debuff", "AllEnemies", "Debuff", mana: 14, power: 0, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
        ...
        await UpsertSkillAsync("canon.skill.lame-de-fond", "Lame de fond",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 18, power: 26, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
            category: "Physical");
        ...
        await UpsertSkillAsync("canon.skill.lame-de-fond-renforcee", "Lame de fond (renforcée)",
            ...
            "Damage", "SingleEnemy", "Damage", mana: 18, power: 39, cancellationToken, emotionalRegister: "Melancolie", audience: "Enemy",
            category: "Physical");
