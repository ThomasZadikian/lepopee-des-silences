...
namespace Leds.Catalog.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260807102726_RemoveItemEffectSetLink")]
    partial class RemoveItemEffectSetLink
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Leds.Catalog.Infrastructure.Persistence.Entities.ItemDefinitionEntity", b =>
                {
                    ...
                    b.Property<string>("Duration")
                        ...
                        .HasColumnType("character varying(64)")
                        .HasColumnName("duration")
                        .HasComment("Legacy compatibility column. Use lifecycle/usage_mode for data-model-0.1 definitions.");
                    ...
                    b.Property<int>("EffectValue")
                        ...
                        .HasComment("Sole source of truth for a used item's effect magnitude, alongside effect_run_type. See ItemDefinitionEntity.EffectRunType.");
