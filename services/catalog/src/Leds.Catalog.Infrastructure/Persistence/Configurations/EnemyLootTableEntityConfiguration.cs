...
public sealed class EnemyLootTableEntityConfiguration : IEntityTypeConfiguration<EnemyLootTableEntity>
{
    public void Configure(EntityTypeBuilder<EnemyLootTableEntity> builder)
    {
        builder.ToTable("catalog_enemy_loot_tables");
        ...
        builder.HasIndex(e => e.EnemyDefinitionKey).IsUnique();
