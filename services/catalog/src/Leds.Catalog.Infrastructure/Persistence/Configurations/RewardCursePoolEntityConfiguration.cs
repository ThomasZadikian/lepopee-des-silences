...
public sealed class RewardCursePoolEntityConfiguration : IEntityTypeConfiguration<RewardCursePoolEntity>
{
    public void Configure(EntityTypeBuilder<RewardCursePoolEntity> builder)
    {
        builder.ToTable("catalog_reward_curse_pools");
