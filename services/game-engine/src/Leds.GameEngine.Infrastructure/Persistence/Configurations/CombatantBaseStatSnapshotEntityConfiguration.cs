...
public sealed class CombatantBaseStatSnapshotEntityConfiguration : IEntityTypeConfiguration<CombatantBaseStatSnapshotEntity>
{
    public void Configure(EntityTypeBuilder<CombatantBaseStatSnapshotEntity> builder)
    {
        builder.ToTable("run_combatant_base_stat_snapshots");
        ...
        builder.HasOne(e => e.Combatant)
            .WithOne(e => e.BaseStatSnapshot)
            .HasForeignKey<CombatantBaseStatSnapshotEntity>(e => e.CombatantId)
